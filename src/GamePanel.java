...
public class GamePanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void paint(Graphics g) {
        ...
        ImageIcon backgroundIcon = new ImageIcon("2.png");
    ...
    public void handleInput(int keyCode) {
        if(keyCode == KeyEvent.VK_1) {
            ...
            restart();
        } else if(gameState == GameState.PlacingShips && keyCode == KeyEvent.VK_3) {
    ...
    private void placeShip(Position targetPosition) {
        ...
        if(placingShipIndex < SelectionGrid.BOAT_SIZES.length) {
            ...
            statusPanel.setTopLine("Attack the AI!");
            statusPanel.setBottomLine("Destroy all Ships!");
        }
    }
